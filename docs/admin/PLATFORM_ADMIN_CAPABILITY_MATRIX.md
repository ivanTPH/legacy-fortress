...
| `/admin/access` | Support/access operations snapshot | Operational issue queue | Invitation-linked case detail and lifecycle actions | Assignment, escalation, notes and case state | Shared table/cards | Partial | Estate case coverage is split with probate routes |
