-- Repair canonical asset payload RPCs for environments where pgcrypto lives under
-- the extensions schema and the original unqualified function calls fail at runtime.
