...
export const APP_ROUTE_MANIFEST: AppRouteNode[] = [
  ...
  },
  {
    ...
    enabled: on,
    children: [
      { id: "finances-bank", label: "Banks", path: "/finances/bank", vaultSubsectionKey: "finances_bank", enabled: on },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "legal-identity", label: "Identity Documents", path: "/identity-documents", vaultSubsectionKey: "legal_identity_documents", enabled: on },
      { id: "legal-wishes", label: "Personal Wishes", path: "/personal/wishes", vaultSubsectionKey: "personal_wishes", enabled: on },
  ...
  },
  {
    ...
    vaultSubsectionKey: "personal_possessions",
    enabled: on,
  },
  {
    id: "people-contacts",
